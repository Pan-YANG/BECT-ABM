...
if __name__ == '__main__':
    ...
    # main()
    #
    # # Scenario small scale biofacility (insight S2)
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_0.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # imp.reload(config)
    # imp.reload(gov)
    ...
    # # Scenario small scale biofacility (insight S2)
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_1.out'
    # imp.reload(config)
    # imp.reload(gov)
    # main()
    #
    # # Scenario TMDL1
    # params.result_file = './results/ABM_result_TMDL1.out'
    # params.maintain_RFS = 1
    # params.TMDL_subsidy = 100 * 2.47
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # imp.reload(config)
    # imp.reload(gov)
    # main()
    #
    # # Scenario with policy commitment
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_PC1.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.maintain_RFS = 1
    # imp.reload(config)
    ...
    # # Scenario with policy commitment
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_PC1_SSB1.out'
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # main()
    #
    #
    # # Scenario with policy commitment and small scale biofacility
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_PC1.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.maintain_RFS = 1
    # imp.reload(config)
    ...
    # main()
    #
    # # Scenario CRP relaxation
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_CRP1.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.CRP_relax = 1
    # params.maintain_RFS = 1
    # params.base_cap_for_learn_by_do = 200 * 10 ** 8
    # imp.reload(config)
    # imp.reload(gov)
    # gov.gov_ref_tax_subsidy[4:7, 2] = 0
    # gov.gov_ref_tax_subsidy[4:7, 3] = 0
    ...
    # main()
    # # #
    # # Scenario no learning-by-doing
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_LBD0.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.base_cap_for_learn_by_do = 200*10**8
    # params.maintain_RFS = 1
    ...
    # # Scenario no learning-by-doing
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_LBD0_SSB.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.base_cap_for_learn_by_do = 200*10**8
    # params.maintain_RFS = 1
    ...
    # # Scenario no learning-by-doing
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_LBD0_SSB1.out'
    # params.learn_by_do_rate = 0
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # main()
    #
    # # Scenario new technology introduction in the middle of simulation
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_newtech.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.base_cap_for_learn_by_do = 200*10**8
    # params.maintain_RFS = 1
    # params.is_ref_learn_by_do = 0
    # imp.reload(config)
    # imp.reload(gov)
    # gov.gov_ref_tax_subsidy[4:7, 2] = 0
    # gov.gov_ref_tax_subsidy[4:7, 3] = 0
    ...
    # # Scenario new technology introduction in the middle of simulation
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_newtech_SSB.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.base_cap_for_learn_by_do = 200*10**8
    # params.maintain_RFS = 1
    ...
    # # Scenario new technology introduction in the middle of simulation
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_newtech_SSB1.out'
    # params.base_cap_for_learn_by_do = 200*10**8
    # params.maintain_RFS = 1
    # params.is_ref_learn_by_do = 0
    # imp.reload(config)
    ...
    # main()
    #
    # # Scenario higher learning-by-doing rate
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_LBD2.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.learn_by_do_rate = 8*np.log(0.95)/np.log(2)
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # gov.gov_ref_tax_subsidy[4:7, 2] = 0
    ...
    # main()
    #
    # # Scenario lower neighorhood impact
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_NI1.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.enhanced_neighbor_impact = [0, 0, 0]
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # gov.gov_ref_tax_subsidy[4:7, 2] = 0
    ...
    # main()
    #
    # # Scenario higher neighorhood impact
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_NI3.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.enhanced_neighbor_impact = [1,2,4]
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # gov.gov_ref_tax_subsidy[4:7, 2] = 0
    ...
    # main()
    # #
    # # Scenario higher willingness to pay
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_WP2.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.base_cap_for_learn_by_do = 600 * 10 ** 8
    # params.learn_by_do_rate = 1 * np.log(0.95) / np.log(2)
    # params.maintain_RFS = 1
    # params.IRW = 0.75
    # params.max_WP = 1.75
    # params.farm_type_change_prob = 0.01
    # imp.reload(config)
    # imp.reload(gov)
    # gov.gov_ref_tax_subsidy[4:7, 2] = 0
    # gov.gov_ref_tax_subsidy[4:7, 3] = 0
    ...
    # main()
    # #
    # # Scenario no willingness to pay
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_WP0.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.maintain_RFS = 1
    # params.IRW = 0.001
    ...
    #
    #
    ### Scenarios for insight paper
    # # Scenario carbon & N trading (insight S3)
    # imp.reload(params)
    # params.result_file = './results/ABM_result_IS_CNT.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.base_cap_for_learn_by_do = 200 * 10 ** 8
    # params.maintain_RFS = 1
    # params.carbon_price = 10
    # params.nitrogen_price = 1
    # imp.reload(config)
    # imp.reload(gov)
    # gov.gov_ref_tax_subsidy[4:7, 2] = 0
    # gov.gov_ref_tax_subsidy[4:7, 3] = 0
    ...
    # main()
    #
    # # Scenario consistent policy (insight S4)
    # imp.reload(params)
    # params.result_file = './results/ABM_result_IS_PC1.out'
    # params.maintain_RFS = 1
    # params.carbon_price = 13
    # params.nitrogen_price = 2.2
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # main()
    #
    # # Scenario improved education (insight S5)
    # imp.reload(params)
    # params.result_file = './results/ABM_result_IS_EDU.out'
    # params.maintain_RFS = 1
    # params.carbon_price = 13
    # params.nitrogen_price = 2.2
    # params.maintain_RFS = 1
    # params.enhanced_neighbor_impact[2] = 2.5
    # params.IRW = 2.5
    # params.max_WP = 1
    # params.farm_type_change_prob = 0.01
    # imp.reload(config)
    ...
    ###########################Final simulation for the methodology paper################
    # # Scenario with policy commitment and small scale biofacility
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_PC1.out'
    # params.BCAP_subsidy = 0
    ...
    imp.reload(params)
    params.result_file = './results/ABM_result_MD_SSB_PC1_IRR1_1.out'
    params.BCAP_subsidy = 0
    params.BCAP_cost_share = 0
    params.maintain_RFS = 1
    imp.reload(config)
    imp.reload(gov)
    config.can_refinery_attribute[(config.can_refinery_attribute[:,3]==2) & (config.can_refinery_attribute[:,-1]==0),-2]-= 0.05
    main()

    # Scenario with policy commitment and small scale biofacility
    imp.reload(params)
    params.result_file = './results/ABM_result_MD_SSB_PC1_IRR3_1.out'
    params.BCAP_subsidy = 0
    params.BCAP_cost_share = 0
    params.maintain_RFS = 1
    imp.reload(config)
    ...
    # # Scenario with policy commitment and small scale biofacility
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_PC1_AT1.out' # accepting threshold
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # config.community_attribute[:,1] = -0.1
    # main()
    #
    # # Scenario with policy commitment and small scale biofacility
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_PC1_AT3.out'  # accepting threshold
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.maintain_RFS = 1
    # imp.reload(config)
    ...
    # # Scenario lower neighorhood impact
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_PC1_NI1.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.enhanced_neighbor_impact = [0, 0, 0]
    # params.maintain_RFS = 1
    ...
    # # Scenario higher neighorhood impact
    # imp.reload(params)
    # params.result_file = './results/ABM_result_MD_SSB_PC1_NI3.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.enhanced_neighbor_impact = [0,2,4]
    # params.maintain_RFS = 1
    # imp.reload(config)
    # imp.reload(gov)
    # main()
    ...
    # # Scenario higher willingness to pay
    # imp.reload(params)
    # params.result_file = './results/ABM_result_SSB_PC1_MD_WP2.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.maintain_RFS = 1
    # params.max_WP = 0.75
    ...
    # # Scenario no willingness to pay
    # imp.reload(params)
    # params.result_file = './results/ABM_result_SSB_PC1_MD_WP0.out'
    # params.BCAP_subsidy = 0
    # params.BCAP_cost_share = 0
    # params.maintain_RFS = 1
    # params.max_WP = 0.01
